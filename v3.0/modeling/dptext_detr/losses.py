...
class SetCriterion(nn.Module):
    ...
    def loss_instance_seg_mask(self, outputs, targets, indices, num_inst):
        ...
        losses = {'loss_anchor_weights_map_dice':loss_dice / num_inst,\
    ...
    def forward(self, outputs, targets, gt_instances):
        ...
        indices = self.dec_matcher(outputs_without_aux, targets, 5)
        ...
        if 'aux_outputs' in outputs:
            for i, aux_outputs in enumerate(outputs['aux_outputs']):
                ...
                losses_key = self.dec_losses_all if i < 3 else self.dec_losses_reg
